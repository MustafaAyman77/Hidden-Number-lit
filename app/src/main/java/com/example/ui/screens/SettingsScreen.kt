    ...
    Column(
        ...
        GlassCard(modifier = Modifier.fillMaxWidth()) {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Text(
                    text = if (languageAr) "لعبة الرقم المخفي v1.0.116 - تم تطويرها بأحدث تقنيات أندرويد (Kotlin, Jetpack Compose, Material 3, WebSockets, Audio Track Real-Time Voice)."
                    else "Hidden Number Game v1.0.116 - Built with modern Android technologies (Kotlin, Jetpack Compose, Material 3, WebSockets, Real-Time Audio).",
                    fontSize = 12.sp,
                    color = TextSecondary,
                    lineHeight = 18.sp
                )
